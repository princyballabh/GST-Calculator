...
export default function AdminUpload() {
  ...
  const styles = {
    ...
    dropZone: {
      ...
      padding: "3rem 2rem",
      textAlign: "center",
      backgroundColor: dragActive ? "rgba(153, 88, 42, 0.1)" : "rgba(255,255,255,0.5)",
      transition: "all 0.3s ease",
      cursor: "pointer",
      position: "relative"
    },
    ...
    <div style={styles.container}>
      <div style={{...styles.card, maxWidth: "600px"}}>
        ...
        <form onSubmit={handleUpload} style={styles.form}>
          ...
          >
            ...
            <div style={styles.dropZoneContent}>
              ...
              <div style={{marginTop: "0.5rem", fontSize: "0.9rem", color: "#99582A"}}>
          ...
          {file && (
            <div style={styles.selectedFile}>
              ...
              <div style={{fontSize: "0.9rem", color: "#99582A", marginTop: "0.5rem"}}>
          ...
          <button
            ...
            onMouseEnter={(e) => !(loading || !file) && Object.assign(e.target.style, {...styles.button, ...styles.buttonHover})}
            onMouseLeave={(e) => !(loading || !file) && Object.assign(e.target.style, styles.button)}
          >
        ...
        {uploadResult && (
          <div style={{
            ...styles.resultCard,
            ...(uploadResult.error ? styles.errorResult : styles.successResult)
          }}>
            <h3 style={{color: "#6F1D1B", marginTop: 0, display: "flex", alignItems: "center", gap: "0.5rem"}}>
            ...
            {uploadResult.parsed_rows && (
              <div style={{marginTop: "1rem"}}>
                ...
                {uploadResult.updates && (
                  <div style={{marginTop: "1rem"}}>
                    <div style={{fontWeight: "bold", color: "#6F1D1B", marginBottom: "0.5rem"}}>
                      🔄 Database Updates:
                    </div>
